...
String text41="to make your hero go left, \nflex your middle finger!";
String text51="amazing! now flex your index\n to go right!";
String text61="you're almost ready! now flex \nyour fourth finger for a jump\nto the heavens!";
...
String text91="now go and save our pincess!";
