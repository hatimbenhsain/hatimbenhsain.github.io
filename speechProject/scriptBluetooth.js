...
let node33=new Node("I am jumairy");
...
let node49=new Node("It's jumairy");
...
node33.childOfAll(["your name","you're name","who are you","who're you"]);
node49.childOfAll(["who owns","owner"]);
...
function setup(){
 ...
 //    );
	...
	speechRec.onError=speechRecRestart;
	speechRec.onEnd=speechRecRestart;
...
function writeToBle(value) {
	if(bleConnected && myBle.isConnected()) myBLE.write(myCharacteristic, value);
}
...
function speechRecRestart(){
	speechRec.start();
	print("restart speech rec");
}
